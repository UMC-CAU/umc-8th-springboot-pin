...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 1664516699L;
    ...
    public final com.example.umc2025.domain.QMember member;

    public final com.example.umc2025.domain.QMission mission;

    public final EnumPath<com.example.umc2025.domain.enums.MissionStatus> status = createEnum("status", com.example.umc2025.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.example.umc2025.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new com.example.umc2025.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
